...
import com.logistics.template.application.facade.InventoryFacade;
...
public class CommandController {
    ...
    private final InventoryFacade sampleFacade;
    private final InventoryCommandService sampleCommandService;
    ...
    public ApiResponse<Void> update(@PathVariable UUID sampleId, @Valid @RequestBody SampleUpdateRequest request) {
        sampleCommandService.update(new UpdateInventoryCommand(sampleId, request.name()));
