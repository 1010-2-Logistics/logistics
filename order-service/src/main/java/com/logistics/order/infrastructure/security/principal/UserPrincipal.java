package com.logistics.order.infrastructure.security.principal;
...
public class UserPrincipal {
    ...
    public void validateRoleConstraints() {
        ...
        // hubId 없어야함
        // companyId 없어야함.
        if (this.role == Role.MASTER && (this.hubId != null || this.companyId != null)
        ) throw new CustomException(CommonErrorCode.AUTH_FORBIDDEN);

        // HUB_MANAGER or HUB_DELIVERY_MANAGER
        // hubId 있어야함
        // companyId 없어야함
        if ((this.role == Role.HUB_MANAGER || this.role == Role.HUB_DELIVERY_MANAGER)
