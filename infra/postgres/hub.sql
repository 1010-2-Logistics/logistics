...
CREATE SCHEMA IF NOT EXISTS hub_route_service;

CREATE TABLE IF NOT EXISTS hub_route_service.p_hub_route (
    hub_route_id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
    start_hub_id UUID,
    end_hub_id   UUID,
    duration     INTEGER,
