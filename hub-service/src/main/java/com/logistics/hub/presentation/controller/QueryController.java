...
import com.logistics.hub.presentation.controller.dto.response.HubResponse;
import com.logistics.hub.presentation.controller.dto.response.HubSummaryResponse;
...
public class QueryController {
    ...
    @GetMapping("/{hubId}")
    public ApiResponse<HubResponse> get(@PathVariable UUID sampleId) {
        Hub hub = hubQueryService.get(new GetHubQuery(sampleId));
    ...
    public ApiResponse<PageResponse<HubSummaryResponse>> search(
            ...
            Pageable pageable) {
        Page<Hub> page = hubQueryService.search(new SearchHubQuery(keyword, pageable));
