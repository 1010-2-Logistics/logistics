...
public interface UserClient {
	...
	@PatchMapping("/internal/v1/users/affiliation")
	ApiResponse<UserRoleUpdateClientResponseDto> compnayManagerRoleUpdateRequest(UserRoleUpdateClientRequestDto request);
